...
const Home = () => {
  return (
    <div name="home" className="h-screen w-full ">
        <div className="max-w-full mx-auto  flex flex-col items-center justify-center h-full px-10  sm:flex-row">
            ...
            <div className="flex flex-col justify-center ml-8 h-full w-1/2 ">
                <h2 className="text-4xl md:text-6xl font-bold text-black"> We Service , Maintain And Safety-Check for Cars, UTES and 4WD </h2>
